...
#         # self.parent().ui = mainwindowui.Ui_MainWindow()
...
#         """
#         old_button = self.parent().findChild(QPushButton, self.current_tool)
#         button = self.findChild(QPushButton, tool)
#         print('old_button', old_button)
#         print('button', button)
...
#             text_options_widget = TextOptionsWidget(self.parent().ui.toolOptionsGridWidget)
#             text_options_widget.setObjectName('text_options_widget')
#             self.parent().ui.toolOptionsGridWidget.layout().addWidget(text_options_widget)
#         else:
#             child = self.parent().ui.toolOptionsGridWidget.findChild(QWidget, 'text_options_widget')

#             if child is not None:
#                 self.parent().ui.toolOptionsWidget.layout().removeWidget(child)
...
#         button = QPushButton(self.parent().ui.toolOptionsWidget)
...
#         self.parent().ui.verticalLayout.addWidget(button)
#         self.parent().ui.verticalLayout.insertWidget(self.parent().ui.verticalLayout.count() - 1, button)
#         button.setText("")
